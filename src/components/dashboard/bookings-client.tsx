        ...
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                ...
                <div className="flex gap-3">
                    <Button variant="outline" className="gap-2">
                        <CalendarIcon className="h-4 w-4" /> {t('bookings.calendar_view')}
                    </Button>
                    <Button className="gap-2">
                        {t('bookings.export_list')}
                    </Button>
                </div>
            </div>
            ...
            <Card className="border-none shadow-sm overflow-hidden">
                <CardHeader className="bg-white border-b border-gray-100">
                    <CardTitle className="text-lg font-bold">{t('bookings.recent')}</CardTitle>
                </CardHeader>
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-gray-50/50 text-gray-500 text-xs uppercase tracking-wider">
                                    <th className="px-6 py-4 font-semibold">{t('bookings.patient')}</th>
                                    <th className="px-6 py-4 font-semibold">{t('bookings.service')}</th>
                                    <th className="px-6 py-4 font-semibold">{t('bookings.date_time')}</th>
                                    <th className="px-6 py-4 font-semibold">{t('bookings.status')}</th>
                                    <th className="px-6 py-4 font-semibold text-right">{t('bookings.actions')}</th>
                                </tr>
                            </thead>
